...
<tr>
<td><img src="./docs/screenshots/hero-apa.png" alt="APA-styled report" width="380" /></td>
<td><img src="./docs/screenshots/hero-gb7714.png" alt="GB/T 7714-styled report" width="380" /></td>
</tr>
</table>
...
Drop a `references.bib`, cite with `<Cite id="..." />`, and pick a style in front-matter. Inline citations and the bibliography are generated by citeproc from vendored CSL styles — structurally impossible to get wrong. **APA 7** and **GB/T 7714-2015** ship today (MLA and Chicago are on the roadmap); GB/T 7714, the Chinese academic standard, is first-class from day one.
...
```bash
pnpm run export getting-started                  # → getting-started.pdf
pnpm run export getting-started --format html    # → self-contained HTML
```
